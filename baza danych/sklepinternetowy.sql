...
--
-- Host: 127.0.0.1
-- Czas generowania: 30 Gru 2017, 14:16
...
CREATE TABLE `produkty` (
  ...
  `opisSlowny` varchar(75) DEFAULT NULL,
...
(1, 'LAPTOP ACER A515 FHD', 1200.00, 17, 'Acer Aspire 5 i5-7200U 2x2.50-3,10GHz/15,6 ...', 2, 'Zdjecia/laptop_acer_a515_fhd.jpg'),
(2, 'ACER SPIN 5 SP531 i5', 2399.00, 89, 'Szybki, niezawodny, bezkompromisowy ...', 2, 'Zdjecia/acer_spin_5_sp531_i5.jpg'),
(3, 'ACER ASPIRE V13 i3 2', 255.00, 100, 'SPECYFIKACJA TECHNICZNA PROCESOR  INTEL CORE i3-4005U 2x1.7GHz MATRYCA  13.', 2, 'Zdjecia/acer_aspire_v13_i3.jpg'),
(4, 'OKAP KUCHENNY CUBA K', 265.00, 91, 'Ergonomiczne sterowanie mechaniczne ...', 1, 'Zdjecia/okap_kuchenny_cuba.jpg'),
(5, 'Lodówka do zabudowy ', 2829.00, 19, 'Lodówka do zabudowySamsung BRB260 ...', 1, 'Zdjecia/lodowka_do_zabudowy.jpg'),
(6, 'OKAP TELESKOPOWY KUC', 169.00, 213, 'Okap kuchenny marki Berdsen, model BT-230 ...', 1, 'Zdjecia/okap_teleskopowy_kuchenny.jpg');
...
(10, 1, '2017-12-20', 1, 1, 1, 5, 100.00),
(11, 1, '2017-12-22', 1, 1, 0, 6, 100.00),
(12, 1, '2017-12-22', 1, 1, 1, 6, 1.00),
(13, 1, '2017-12-28', 2, 1, 0, 6, 120.00),
(14, 2, '2017-12-28', 2, 1, 0, 6, 999.99),
(15, 4, '2017-12-28', 2, 1, 0, 6, 265.00),
(16, 6, '2017-12-28', 2, 1, 0, 6, 169.00),
(17, 2, '2017-12-28', 1, 1, 0, 6, 999.99),
(18, 1, '2017-12-28', 1, 1, 0, 6, 999.99),
(19, 1, '2017-12-28', 1, 1, 0, 6, 1200.00),
(20, 5, '2017-12-28', 1, 1, 0, 6, 2829.00),
(21, 6, '2017-12-30', 1, 1, 1, 6, 169.00);
...
--
ALTER TABLE `kategorie`
  MODIFY `idKategorii` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `produkty`
  MODIFY `idProduktu` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `zamowienia`
  MODIFY `idZamowienia` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
COMMIT;
